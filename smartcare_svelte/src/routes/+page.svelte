<script>
  ...
  let contactMethod = [
    { header: 'Phone', value: '01189395643' },
    { header: 'Email', value: 'SmartcareSurgery@gmail.com' },
    { header: 'Address', value: '123 Bristol Rd., Bristol, BR127OL ' },
    { header: 'Out of hours', value: '111' }
  ];
</script>
